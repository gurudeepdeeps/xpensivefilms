  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      <button
        ...
        type="button"
        className={cn(
          "absolute h-11 w-11 rounded-2xl bg-[#0b0720]/90 backdrop-blur-md border border-white/20 text-white flex items-center justify-center transition-all hover:bg-indigo-600 hover:scale-110 hover:border-white/40 disabled:opacity-30 disabled:cursor-not-allowed z-30 shadow-xl",
          orientation === "horizontal"
